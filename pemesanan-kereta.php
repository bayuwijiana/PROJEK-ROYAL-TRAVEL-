...
<div id="clients" class="the-clients">
    ...
    <div class="container" style="margin-top:-70px">
     <h3> <img src="assets/images/2.png" style="height:80px;width: 80px;"><b> pemesanan </b>
    </h3>
      
      <div class="row">       
                         <form action="oke3.php" method="post">
                      ...
                      <?php	
                                 ...
                                 $f=new pesan();
                                 foreach ($f->tampil_kereta5($id_kereta) as $data2) {
                      ?>             
                                      ...
                                      <tr >
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td> <input type="date" name="tanggal_berangkat_kereta" required> </td>
                                        <td> <input type="number" name="jumlah_penumpang" required> </td>
                                        <td>
                                          <select name="kelas_kereta" id="" required>
                                        ...
                                        <td>
                                                  ...
                                                  <input type="hidden" name="nama_kereta" value="<?=$data2['nama_kereta']?>">
                                                  <input type="hidden" name="harga" value="<?=$data2['harga']?>">
                                                  
                                                  <input type="hidden" name="kota_tujuan_kereta" value="<?=$data2['kota_tujuan_kereta']?>">
                                                  <input type="hidden" name="nama_stasiun" value="<?=$data2['nama_stasiun']?>">
                                                  <input type="hidden" name="jam_berangkat_kereta" value="<?=$data2['jam_berangkat_kereta']?>">

...
<body>
    ...
    <div class="container-fluid">
        <main class="tm-main">
                ...
                <?php     
                           $ban=new bandara();
                            foreach ($ban->tampil_bandara($nama) as $data2){
                                if($data2['nama_pesawat']==""){
                                }else{
                ?>
                                ...
                                <tr>
                                                        <td><?=$nomor++?></td>
                                                        <td >
                                                            <img style="width:100px;hight:40px;" src="../assets/images/<?=$data2['gambar_pesawat']; ?>">
                                                        </td>
                                                        ...
                                                        <td><?=$data2['jumlah_kursi']?></td>   
                                                        
                                                                    
                                
                                <td>
                                                            <form action="edit-pesawat.php" method="post">
                                                            <input type="hidden" name="id" value="<?=$data2['id_pesawat']?>">
            ...
            <form action="" method="post" >
                ...
                <input type="hidden" name="nama_bandara" value="<?= $nama	?>">

                <tr>
                    <td>Nama Pesawat</td>
                    <td><input type="text" name="nama_pesawat"required> </td>
                </tr> 
                <tr>
                    <td>Tujuan</td>
            ...
            if(isset($_POST['tambah'])){
               ...
               $c=new bandara();
                    $c=$c->tambahc($nama,$nama_pesawat,$tujuan,$jam_berangkat,$jumlah,$harga,$kelas);

...
<hr class="tm-hr-primary tm-mb-55">
            ...
            <div class="row tm-row">
                    ...
                    <form method="post" class="form-inline tm-mb-80 tm-search-form">                
                        <input class="form-control tm-search-input" name="nama" type="text" placeholder="Search Pemesan/stasiun/Tujuan/Harga" aria-label="Search">
                  ...
                  include "read_admin.php";
                    ...
                    if(isset($_POST['cari5'])){
                        $nama=$_POST['nama'];
                            $nomor=1;
                            foreach ($c->tampil_kereta($nama) as $data2){
                ...
                <?php	
                                ...
                                $nomor=1;
                                foreach ($c->tampil_kereta2() as $data2){

                                               ...
                                               <table style="width:100%">
                                                     <form action="" method="post">
                                                        <tr>    
                                                            ...
                                                            <input type="hidden" name="j" value="<?=$data2['id_kereta']?>">
                                                           <td >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                            <input type="text" name="k" value="<?=$data2['nama_kereta']?>" required>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input type="text" name="l" value="<?=$data2['kota_asal_kereta']?>" required>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                            <input type="text" name="m" value="<?=$data2['kota_tujuan_kereta']?>"required>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="time" name="o" value="<?=$data2['jam_berangkat_kereta']?>"required>

                                                ...
                                                <table style="width:100%;"> 
                                                     <form action="" method="post">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" name="nama_bandara" required>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input type="text" name="kota_asal" value="" required>
                                                            </td>               
                                                        </tr>
                                                             <td>
                                                                <button class= "btn btn-secondary " name="tambah2" type="submit"><b>Tambah</b></button>                       
                                                            </td>
                                                        </tr>
                    <?php	
                                if(isset($_POST['tambah2'])){
                                    $n=$_POST['nama_bandara'];
                                    $k=$_POST['kota_asal'];

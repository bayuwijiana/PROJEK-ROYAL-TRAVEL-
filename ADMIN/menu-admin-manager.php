...
session_start();
if (!isset($_SESSION["login-admin-manager"])) {
    echo "<script>
...
<body>
        ...
        <div class="tm-header-wrapper">
            ...
            <nav class="tm-nav" id="tm-nav">
                <ul>
                    ...
                    <li class="tm-nav-item"><a href="data-pemesanan-pesawat.php" class="tm-nav-link">
    ...
    <div class="container-fluid">
        <main class="tm-main">
            ...
            if ($_SESSION['ussername_admin-pesawat'] == "admin_manager") {
            ?>
                </li>
            ...
            <H1> <b> DATA BANDARA</b></H1>
            <div class="row tm-row">
                <form action="" method="post">
                    <button style="font-size:26px;width:200px;" class="btn btn-primary" name="semua">Semua Bandara</button>
                </form>
                <br><br>
                <form method="post" class="form-inline tm-mb-80 tm-search-form">
                    <input class="form-control tm-search-input" name="nama" type="text" placeholder="Search Bandara" aria-label="Search" required>
                ...
                <a href="tambah-bandara.php">
                    <button style="font-size:26px;width:200px;" class="btn btn-primary" name="tambah_bandara">ADD Bandara</button>
                </a> <br>
                <h2><b>DAFTAR BANDARA</b></h2>
                <table class="table table-dark table-striped" style="font-size:20px;width: 100%;margin-top:10px;">
                    ...
                    if (isset($_POST['cari'])) {
                        $nama = $_POST['nama'];
                        $nomor = 1;
                        foreach ($c->tampil_bandarax($nama) as $data2) {

                    ?>
                            <tr>
                                <td><?= $nomor++ ?></td>
                                <td>
                                    <img style="width:100px;hight:40px;" src="../assets/images/<?= $data2['gambar_bandara']; ?>">
                                </td>
                                <td><?= $data2['nama_bandara'] ?></td>
                                <td><?= $data2['kota_asal_pesawat'] ?></td>

                                <td>
                                    <form action="edit-bandara.php" method="post">
                                ...
                                <td>
                                    <form action="tampil-pesawat.php" method="post">
                                        <input type="hidden" name="nama_bandara" value="<?= $data2['nama_bandara'] ?>">
                        ...
                        $nomor = 1;
                        foreach ($c->tampil_bandara2() as $data2) {
                ...
                if (isset($_POST['hapus'])) {
                    $nama = $_POST['nama_bandara'];
                    $a = $ban->hapus_bandara($nama);
                }
                ?>

...
<body>
    ...
    <div class="container-fluid">
        <main class="tm-main">
                  ...
                  <?php	        $c= new bandara();
                                $z=$_POST['nama_bandara'];
                                $nomor=1;
                                foreach ($c->tampil_bandarax($z) as $data2){

                    ?>                          <h2><b>EDIT BANDARA </b></h2>
                    <hr class="tm-hr-primary tm-mb-55">
                                                <table style="width:100%;"> 
                                                     <form action="" method="post">
                                                        <tr>      
                                                           <td >
                                                               <input type="hidden" name="z" value="<?=$data2['nama_bandara']?>" >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                            <input type="text" name="n" value="<?=$data2['nama_bandara']?>" required>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input type="text" name="k" value="<?=$data2['kota_asal_pesawat']?>" required>

        ...
        <div class="tm-header-wrapper">
            ...
            <nav class="tm-nav" id="tm-nav"> 
                <ul>
                    ...
                    <li class="tm-nav-item"><a href="data-pemesanan-kereta.php" class="tm-nav-link">
    ...
    <div class="container-fluid">
        <main class="tm-main">
            <?php	
                    ...
                    if($_SESSION['ussername_admin-kereta']=="admin_manager"){
                    ?>
                    </li>
...
<hr class="tm-hr-primary tm-mb-55">
            <H1> <b> DATA STASIUN</b></H1>
            <div class="row tm-row">
                    <form action="" method="post" >
                        <button style="font-size:26px;width:200px;" class="btn btn-primary" name="semua">Semua STASIUN</button>
                     </form><br><br>
                    ...
                    <a href="tambah-stasiun.php">
                        <button style="font-size:26px;width:200px;" class="btn btn-primary" name="tambah_stasiun">ADD STASIUN</button> 
                        </a> <br>
                    <h2><b>DAFTAR STASIUN</b></h2>
                  ...
                  include "read_admin.php";
                    ...
                    if(isset($_POST['cari'])){
                        $nama=$_POST['nama'];
                            $nomor=1;
                            foreach ($c->tampil_stasiunx($nama) as $data2){
                            
                ?>
                                <tr>
                                                        <td><?=$nomor++?></td>
                                                        <td >
                                                            <img style="width:100px;hight:40px;" src="../assets/images/<?=$data2['gambar_stasiun']; ?>">
                                                        </td>
                                                        <td><?=$data2['nama_stasiun']?></td>
                                                        <td><?=$data2['kota_asal_kereta']?></td>               
                                
                                <td>
                                                            <form action="edit-stasiun.php" method="post">
                                                            <input type="hidden" name="id_kereta" value="<?=$data2['id_kereta']?>">
                                                            <input type="hidden" name="nama_stasiun" value="<?=$data2['nama_stasiun']?>">
                                ...
                                <td>
                                    <form action="tampil-kereta.php" method="post">
                                            <input type="hidden" name="nama_stasiun" value="<?=$data2['nama_stasiun']?>">
                ...
                <?php	
                                ...
                                $nomor=1;
                                foreach ($c->tampil_stasiun2() as $data2){

...
session_start();
 if(!isset( $_SESSION["ussername_admin-info"] )){
        echo "<script>
        ...
        <div class="tm-header-wrapper">
            ...
            <nav class="tm-nav" id="tm-nav"> 
                <ul>
                    ...
                    <li class="tm-nav-item"><a href="menu-admin-info.php" class="tm-nav-link">
                         <img style=" margin-right: 10px;height: 40px;width:40px;border-radius: 10px;" src="../assets/images/oke5.jpg" alt="ROYAL TRAVEL">
                        DATA INFO
                    </a></li>

                    
                    <li class="tm-nav-item"><a href="#notices" class="tm-nav-link">
    ...
    <div class="container-fluid">
        <main class="tm-main">
            <?php	
                    ...
                    if($_SESSION['ussername_admin-info']=="admin_manager"){
                    ?>
                    </li>
...
<hr class="tm-hr-primary tm-mb-55">
            <H1> <b> DATA USSER</b></H1>
            <div class="row tm-row">
                    <form action="" method="post" >
                        <button style="font-size:26px;width:200px;" class="btn btn-primary" name="semua">ALL USSER</button>
                     </form><br><br>
                  ...
                  include "read_admin.php";
                    ...
                    if(isset($_POST['cari'])){
                        $nama=$_POST['nama'];
                            $nomor=1;
                            foreach ($c->tampil_usserx($nama) as $data2){
                            
                ?>
                                <tr>
                                                        <td><?=$nomor++?></td>
                                                        <td >
                                                            <img style="width:100px;hight:40px;" src="../assets/images/<?=$data2['foto']; ?>">
                                                        </td>
                                                        <td><?=$data2['ussername_usser']?></td>
                                                        
                                                        <td><?=$data2['no_telepon_usser']?></td>
                                                        <td><?=$data2['saldo']?></td>
                                                            <td>
                                                                <form action="" method="post">
                                ...
                                <td>
                                      <form action="" method="post">
                                        <input type="hidden" name="ussername_usser" value="<?=$data2['ussername_usser']?>">
                                        <input type="text">
                                </td>
                                <td>     
                                    <button class= "btn btn-secondary " name="saldo" type="submit"><b>Top up</b></button>
                                </form>
                            </td>
                ...
                <?php	
                                ...
                                $nomor=1;
                                foreach ($c->tampil_usser2() as $data2){
                ...
                ?>
                  ...
                  $ban=new bandara();
                   if(isset($_POST['hapus'])){
                        $nama=$_POST['ussername_usser'];
                        $a=$ban->hapus_usser($nama);
                    }
                    ?>
            ...
            <div id="notices">
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <input type="text" name="pesan" required style="width:500px;height:300px">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <button class="btn btn-secondary" name="kirim">
                                KIRIM
                            </button>
                        </td>
                    </tr>
                ...
                <?php	
                    if(isset($_POST['saldo'])){
                        $a=new PESAN();
                        $a=$a->top($_POST['jumlah'],$_POST['ussername_usser']);
            ...
            <div>
                ...
                ?>
                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="" method="post">
                                                                <input type="hidden" name="id" value="<?=$data2['id_pesan']?>">
                                                                <button class="btn btn-secondary" name="hapus">DELETE</button>
                                                            </form>
                                                        </td>
                    </tr>
                    <?php

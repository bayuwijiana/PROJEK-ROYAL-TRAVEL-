...
<div id="clients" class="the-clients">
    ...
    <div class="container" style="margin-top:-70px">
     <h3> <img src="assets/images/2.png" style="height:80px;width: 80px;"><b> pemesanan </b>
      ...
      <div class="row">       
                         <form action="oke1.php" method="post">
                      ...
                      <?php	
                                 ...
                                 $id_bus=$_POST['id_bus'];
                                 $f=new pesan();
                                 foreach ($f->tampil_bus5($id_bus) as $data2) {
                      ?>             
                                      ...
                                      <tr >
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td> <input type="date" name="tanggal_berangkat_bus" required> </td>
                                        ...
                                        <td>
                                                  ...
                                                  <input type="hidden" name="nama_bus" value="<?=$data2['nama_bus']?>">
                                                  <input type="hidden" name="kota_tujuan_bus" value="<?=$data2['kota_tujuan_bus']?>">
                                                  <input type="hidden" name="nama_terminal" value="<?=$data2['nama_terminal']?>">
                                                  <input type="hidden" name="jam_berangkat_bus" value="<?=$data2['jam_berangkat_bus']?>">

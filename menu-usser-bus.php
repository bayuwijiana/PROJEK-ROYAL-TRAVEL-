        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div  class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1.1s" data-wow-delay="1s">
                    <div class="service-item second-service">
                        <div class="info2">
                            <a href="#oke2"><img style="height:150px;width:150px;" src="assets/images/logobus.jpg" alt=""></a>
                            <h2>Bus</h2>
                            <h4>Paket Diskon Bus Bikin Perjalanan Semakin Nyaman</h4>
                        </div>
                        <img style="border-radius:12px; height:20px;width:100%;" src="assets/images/neon.jpg" alt="">
                    </div>
                </div>
            </div>
...
<div id="services" class="services section">
    ...
    <div id="oke2" >
        ...
        <h1 
        style= " font-size:50px ;font-weight:bold;font-family: Georgia, 'Times New Roman', Times;"><img style="height:200px;width:200px;" src="assets/images/penerbangan.jpg" >LINTAS BUS<b style="font-family: Georgia, 'Times New Roman', Times; color:rgb(218,165,32) " > ROYAL</b>TRAVEL</h1>
        <center>
         <div style="background-color:gray; height:10px;width:95%;border-radius:10px; "></div>
         </center>
       <h2><b style="margin-left:30px;">DAFTAR TERMINAL</b></h2>
    </div>
          ...
          <div class="section-heading  wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.5s">
                  <center>
                      ...
                      <?php	
                                  ...
                                  $b= new a();
                                  $nomor=1;  
                                  if(mysqli_num_rows($b->tampil_bus3($z))===0){
                                     echo"<script>
                                  ...
                                  foreach ($b->tampil_bus3($z) as $data2){
                      ?>             
                                      
                                      <tr style="height:300px">
                                            <td><?=$nomor++?></td>
                                            <td >
                                                  <img style="height: 200px;width:100%;" src="assets/images/<?=$data2['gambar_terminal']; ?>">
                                            </td>
                                            <td><?=$data2['nama_terminal']?></td>
                                            <td><?=$data2['kota_asal_bus']?></td>
                                            <td>  
                                                <form action="" method="post">
                                                    <input type="hidden" name="xc" value="<?= $data2['nama_terminal']?>">
          ...
          <div class="s ection-heading  wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.5s">
                  <center>
                      ...
                      ?>      
                              ...
                              <h2> <b> JADWAL LINTAS TERMINAL  <?=$x3?></b></h2><br>
                              <table class="table table-dark table-striped" style="font-size:23px;width: 95%;">
                      ...
                      <?php	
                                    ...
                                    foreach( $m->tampil_bus4($b2) as $data2){                             
                      ?>             
                                      <tr style="height:60px">
                                            <td><?=$nomor++?></td>
                                            <td >
                                                  <img style="height: 50px;width:100%;" src="assets/images/<?=$data2['gambar_bus']; ?>">
                                            </td>
                                            ...
                                            <td>  
                                                <form action="pemesanan-bus.php" method="post">

            ...
            <div class="col-lg-3">
                <div  class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                    <div class="service-item first-service">
                        <div class="info1">
                            <a href="#oke6"><img style="height:150px;width:150px;" src="assets/images/pesawat.png" alt=""></a>
                            <h2>Pesawat</h2>
                            <h4>Temukan penerbangan dengan harga terbaik.</h4>
                            
                            <a href="#notices">
                               <img style="height:50px;width:50px;border-radius:10px;" src="assets/images/n.png" alt="">notice
                            </a><br>
                           ...
                           <form style="margin-top:20px" action="ADMIN/profil.php" method="post">
                                  <input type="hidden"  name="nama" value="<?= $_SESSION['ussername_usser']	?>">                               
                            ...
                            <h2 style="color:gray">
                          <?= 	$_SESSION['ussername_usser'];?>
                            </h2>


                            <?php	
                            $ab=new a();
                            foreach ($ab->saldo($_SESSION['ussername_usser']) as $key){
                              $as=$key['saldo'];
                            }
                        ...
                        <img style="border-radius:12px; height:20px;width:100%;" src="assets/images/neon1.jpg" alt="">
                    </div>
                </div>
            </div>
...
<div id="services" class="services section">
    ...
    <div id="oke6" >
        ...
        <h1 
        style= " font-size:50px ;font-weight:bold;font-family: Georgia, 'Times New Roman', Times;"><img style="height:200px;width:200px;" src="assets/images/penerbangan.jpg" >PENERBANGAN <b style="font-family: Georgia, 'Times New Roman', Times; color:rgb(218,165,32) " > ROYAL</b>TRAVEL</h1>
        <center>
         <div style="background-color:gray; height:10px;width:95%;border-radius:10px; "></div>
         </center>
       <h2><b style="margin-left:30px;">DAFTAR BANDARA</b></h2>
    </div>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
              <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <input class="form-control me-2" type="search" name="cari2" placeholder="cari nama bandara/kota" aria-label="Search"; required>
          ...
          <div class="section-heading  wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.5s">
                  <center>
                      ...
                      <?php	
                                  ...
                                  $b= new b();
                                  $nomor=1;  
                                  if(mysqli_num_rows($b->tampil_pesawat2($z))===0){
                                     echo"<script>
                                            alert('nama bandara tidak ditemukan , searh sesuai bandara yang ada');
                                             window.location ='menu-usser.php';
                                          </script>"
                                          ;

                                  }else{
                                  foreach ($b->tampil_pesawat2($z) as $data2){
                      ?>             
                                      
                                      <tr style="height:300px">
                                            <td><?=$nomor++?></td>
                                            <td >
                                                  <img style="height: 200px;width:100%;" src="assets/images/<?=$data2['gambar_bandara']; ?>">
                                            </td>
                                            <td><?=$data2['nama_bandara']?></td>
                                            <td><?=$data2['kota_asal_pesawat']?></td>
                                            <td>  
                                                <form action="" method="post">
                  ...
                  <center>
                      <?php	
                          if(isset($_POST['lihat'])){ 
                            $x2= $_POST['nama_bandara'];
                            $x3=strtoupper($x2);
                            
                      ?>      
                              
                              <h2> <b> JADWAL PENERBANGAN BANDARA <?=$x3?></b></h2><br>
                              <table class="table table-dark table-striped" style="font-size:23px;width: 95%;">
                      ...
                      <?php	
                                  ...
                                  $c= new b();
                                  $nomor=1;  
                                  foreach ($c->tampil_pesawat4($x2) as $data2){
                      ...
                      ?>             
                                      <tr style="height:60px">
                                            ...
                                            <td>  
                                                <form action="pemesanan-pesawat.php" method="post">
                ...
                <div class="col-lg-5">
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              <div class="client-content">
                                ...
                                <table  style="font-size:20px;width: 100%;margin-top:10px;" >
                  ...
                  <table class="table table-striped"> 
                    ...
                    <?php	
                     $nomor=1;
                     $c=new PESAN2();
                    foreach ($c->tampil_pesan() as $data2){
                        $d=$data2['id_pesan'];
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        >> Cek <br>
        >>" Search sesuai nama bandara yang ada diindonesia "
      </b>
      </div>
...
<div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <a href="logout.php" class="btn btn-secondary" >iya</a>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">MASUKAN KODE VERIVIKASI !</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <tr>
          <td>VERIVIKASI</td>
          <td><input type="text" placeholder="Kode Verrivikasi" ></td>
        </tr>
      </div>
      <div class="modal-footer">
